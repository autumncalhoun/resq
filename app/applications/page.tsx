          ...
          {!applications || applications.length === 0 ? (
            <Card className="text-center py-12">
              <CardHeader>
                ...
                <CardDescription>Start by browsing available dogs and submitting an application</CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild>
                      ...
                      <div className="flex gap-6">
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between items-start mb-2">
                            <div>
                              <h3 className="text-lg font-semibold">{application.dogs.name}</h3>
                              <p className="text-gray-600">
                                {application.dogs.breed} • {application.dogs.organizations.name}
                              </p>
                            </div>
                          ...
                          <div className="flex gap-2 mt-4">
                            <Button asChild variant="outline" size="sm">
                              <Link href={`/dogs/${application.dogs.id}`}>View Dog</Link>
                            </Button>
                            <Button asChild variant="outline" size="sm">
