  ...
  const applyFilters = () => {
    ...
    if (filters.minAge || filters.maxAge) {
      filtered = filtered.filter((dog) => {
        ...
        const minMonths = filters.minAge
          ? Number.parseInt(filters.minAge) * 12
          : 0
        const maxMonths = filters.maxAge
          ? Number.parseInt(filters.maxAge) * 12
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right text-xs text-gray-500">
                          {dog.size && (
                            <div className="capitalize">{dog.size}</div>
                          )}
                          {dog.gender && (
                            <div className="capitalize">{dog.gender}</div>
                          )}
                        </div>
                      </div>
                    </CardHeader>
